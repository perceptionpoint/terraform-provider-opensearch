...
### Added
* Support prometheus_nodes_filter for clusters running the prometheus-exporter plugin ([#342](https://github.com/opensearch-project/terraform-provider-opensearch/issues/342))
